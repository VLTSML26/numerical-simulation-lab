...
void Random::Metropolis(double xn[], double delta, double (*p)(double[]), string s) {
	double y[3];
	if(s == "Uniform") {
		for(int i=0; i<3; i++)
...
void Random::Tune(double xn[], double& delta, double (*p)(double[]), string s) {
	double x[3];
	bool half = true;
