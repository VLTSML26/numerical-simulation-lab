...
std::function<double(double)> variationalWaveFunction;
// INSTEAD OF double variationalWaveFunction(double);  

std::function<double(double)> variationalWaveFunction_second;
// INSTEAD OF double variationalWaveFunction_second(double);  
...
void finalizePotentialEstimator(string);
void finalizeKineticEstimator(string);
void finalizeHistogram(string);
/*
