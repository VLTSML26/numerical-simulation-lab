...
void qmc1d(double T, string in, string out) {
	...
	consoleOutput();
	finalizePotentialEstimator(out);
	finalizeKineticEstimator(out);
	finalizeHistogram(out);
...
*/
void finalizePotentialEstimator(string fout)
{
	ofstream out(fout + "_potential.out");
	for(int i=0;i<timeslices;i++)
	{
...
void finalizeKineticEstimator(string fout)
{
	ofstream out(fout + "_kinetic.out");
	for(int i=0;i<timeslices;i++)
	{
...
void finalizeHistogram(string fout)
{
	ofstream out(fout + "_probability.out");
